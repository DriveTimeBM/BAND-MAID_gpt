...
It has pretty extensive knowledge of BAND-MAID with a glossary, a brief history of the band, and 18 of the better band interviews used to build the knowledge base.
...
They are generally more comprehensive than the JSON files due to GPT limits, but are still updated by me just like the JSON. Maybe someone could use them.
